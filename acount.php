       ...
       <div class="wrap">
          ...
          <div class="row">
            <table><form action='' method='get'>
              <h3><b>You wish to register as a:</b></h3>
              <a href="registerDoctor.php" class="btn" style="margin-right: 10px">Register as Doctor</a>
              <a href="confirm.php" class="btn">Register as Patient</a>
            </table>
          </div>
          <div id="push">
            <div id="footer">
