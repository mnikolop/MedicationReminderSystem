...
<body>
    ...
    <div class="container-fluid" >
        ...
        <form action="<?php echo esc_url($_SERVER['PHP_SELF']); ?>" 
            ...
            <h3>Username: <small>Here insert the username you want to use for logging in the system</small></h3> <input type='text' name='username' id='username' class="form-control input-lg" /><br>
            <h3>Email: <small>Here insert the email you want to store in the system</small></h3> <input type="text" name="email" id="email" class="form-control input-lg" /><br>
            ...
            <h3>Capacity: <small>If you want to register as a doctor select Doctor. If you want to register as a patient select Patient</small></h3>  <h4> <input type="radio" name="capacity" id="capacity" value="doctor" /> Doctor</h4>
